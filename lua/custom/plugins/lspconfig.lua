...
--
-- LSP stands for Language Server Protocol. Language Servers (such as `gopls`,
-- `lua_ls`, `rust_analyzer`) are standalone processes that provide Neovim with
-- features like go to definition, find references, autocompletion and symbol
-- search. They are external tools installed separately from Neovim - that is
-- where `mason` and related plugins come into play.
--
-- If you're wondering about lsp vs treesitter, see `:help lsp-vs-treesitter`
return {
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        -- Helper to define LSP-specific mappings: sets the mode, buffer and
